...
history.replace(history.forward(1));
	...
	<body>
		...
		<div id="wrapper">
			<div id="page" class="container">
				...
				<div id="content">
					...
					<div align="center" class="noticia">
						<form action="votoya.php" method="post" class="login">
							<div class="div-registro">
								<img class="foto" src="1.png"  />
								<div class="registro2">
									<br>
									<strong>NOMBRE</strong>
									<br>
									Carmen Cecilia Duran Torres

									<br>
									<br>
									<strong>LEMA</strong>
									<br>
									"Juntos por nuestros derechos y obligaciones"
									<br>
									<br>
					...
					<div align="center" class="noticia">
						...
						<div class="div-registro">
							<img class="foto" src="2.png"  />
							<div class="registro2">
								<br>
								<strong>NOMBRE</strong>
								<br>
								Tatiana Sepulveda Arrieta
								<br>
								<br>
								<strong>LEMA</strong>
								<br>
					...
					<a href="votoya.php">
					<input name="VOTAR" type="submit" value="votar" action="votoya.php" method="post">
					</a>
					</form>
	  ...
	  <a href="https://www.facebook.com/profile.php?id=100008326274027"><div  id="fb" >
      <img class="imagefotter"  src="Facebook_Logo.png" class="social" title="siguenos!" /> 
	  </div>
	  
	   
	  <a href="https://twitter.com/Fair_Vote"><div id="tw">
      <img class="imagefotter" src="twitter-logo.png" class="social" title="siguenos!" /> 
			...
			<div id="copyright" class="container">
				<p>
					Copyright (c) 2013 Sitename.com. All rights reserved. | Photos by <a href="http://fotogrph.com/">Fotogrph</a> | Design by <a href="http://www.freecsstemplates.org/" rel="nofollow">FreeCSSTemplates.org</a>.
				</p>
			</div>
	</body>
</html>