...
<?php
require_once realpath(dirname(__FILE__)) . '/actions/funciones.php';
$nits = getInstituciones();
?>
					...
					<center>
						<div class="noticia">
							...
							<div class="div-registro">
								...
								<form action="actions/insertar_est2.php" method="post" >
									<div class="registro2">
										Nombre:
										...
										<br>
										NIT institucion:<?php
										echo '<select name="nit" >';

										foreach ($nits as $nit) {
											echo '<option value="' . $nit['nit'] . '" >' . $nit['nombre'] . '</option>';
										}
